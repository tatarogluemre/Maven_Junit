...
public class C02_ClassWork {
    public static void main(String[] args) {
       ...
       driver.findElement(By.cssSelector("button[id='signin_button']")).click();
        ...
        //6. Online Banking butonuna basın sonra pay bills sayfasina  gidin
        ...
        WebElement actMessage = driver.findElement(By.xpath("//*[text()='The payment was successfully submitted.']"));

        if(actMessage.isDisplayed()){
